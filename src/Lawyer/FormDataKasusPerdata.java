...
public class FormDataKasusPerdata extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(txt_nama_kasus, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 130, 260, -1));
        ...
        jPanel4.add(txt_status_kasus, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, 260, -1));
        ...
        jPanel4.add(txttgl, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 190, 260, -1));
    ...
    private void bsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsaveActionPerformed
        ...
        try{
            String sql = "INSERT INTO data_kasus VALUES ('"+txt_id_klien.getText()+"','"+txt_nama_kasus.getText()+"','"+tanggal+"','"+txt_status_kasus.getText()+"')";
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        ...
        try{
            String sql = "update data_kasus set Nama_Kasus='"+txt_nama_kasus.getText()+"', Tanggal_Kasus='"+tanggal+"', Status_Kasus='"+txt_status_kasus.getText()+"'  where ID_Klien='"+txt_id_klien.getText()+"'";
