 ...
 * @author Me
 */
public class DataKlienRetainer extends javax.swing.JInternalFrame {
 
    /**
     * Creates new form DataPesertaPKH
     */
    public DataKlienRetainer() {
        initComponents();
    ...
    public void tampilkan_data(){
     DefaultTableModel model = new DefaultTableModel();
       ...
       try{
           int no = 1;
           String sql = "Select * From data_klien_retainer";
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(44, 209, 1041, 291));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel1.setText("Data Klien Retainer");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(44, 67, -1, -1));

        jButton1.setBackground(new java.awt.Color(0, 0, 255));
        jButton1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/plus.PNG"))); // NOI18N
        jButton1.setText("Tambahkan Data Klien");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(837, 140, 230, -1));
        ...
        jPanel2.add(print1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 100, 40));
        ...
        jPanel2.add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 140, -1, 40));
        ...
        jPanel2.add(Reload, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 140, 100, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        FormDataKlienRetainer next =  new FormDataKlienRetainer();
        next.show();
    ...
    private void print1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_print1ActionPerformed
        // TODO add your handling code here:
         try {
              File namafile = new File("src/report/report_data_klien_retainer.jasper");
