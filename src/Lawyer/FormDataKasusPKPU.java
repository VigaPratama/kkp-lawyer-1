...
public class FormDataKasusPKPU extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 900, 440));
    ...
    private void bsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsaveActionPerformed
        ...
        try{
            String sql = "INSERT INTO data_kasus_pkpu VALUES ('"+txt_id_klien.getText()+"','"+txt_nama_kasus.getText()+"','"+tanggal+"','"+txt_status_kasus.getText()+"')";
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        ...
        try{
            String sql = "update data_kasus_pkpu set Nama_Kasus='"+txt_nama_kasus.getText()+"', Tanggal_Kasus='"+tanggal+"', Status_Kasus='"+txt_status_kasus.getText()+"'  where ID_Klien='"+txt_id_klien.getText()+"'";
