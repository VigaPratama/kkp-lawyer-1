 ...
 * @author Me
 */
public class DataKlienUmum extends javax.swing.JInternalFrame {
 
    /**
     * Creates new form DataPesertaPKH
     */
    public DataKlienUmum() {
        initComponents();
    ...
    public void tampilkan_data(){
     DefaultTableModel model = new DefaultTableModel();
       ...
       try{
           int no = 1;
           String sql = "Select * From data_klien";
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(44, 217, 1041, 291));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel1.setText("Data Klien Umum");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(44, 67, 210, -1));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(847, 140, 220, 40));
        ...
        jPanel2.add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 140, 100, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        FormDataKlienUmum next =  new FormDataKlienUmum();
        next.show();
    ...
    private void print1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_print1ActionPerformed
        // TODO add your handling code here:
         try {
              File namafile = new File("src/report/report_data_klien_umum.jasper");
